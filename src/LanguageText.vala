namespace DesktopFolder.Lang {
    ...
    // Item - Delete Item Dialog message
    public const string ITEM_DELETE_FILE_MESSAGE_TITLE     = _ ("Are you sure you want to permanently delete \"%'s\"?");
    // Item - Delete Item Dialog message
    public const string ITEM_DELETE_FILE_MESSAGE_TITLE_MULTIPLE     = _ ("Are you sure you want to permanently delete the %'d selected items?");
    // Item - Delete File Item Dialog message
    public const string ITEM_DELETE_FILE_MESSAGE           = _ ("If you delete an item, it will be permanently lost.");
