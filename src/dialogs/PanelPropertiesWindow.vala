...
namespace DesktopFolder.Dialogs {
    ...
    public class ShowInfo : Gtk.Window {
        ...
        public ShowInfo(string fpath, string fname) {
            ...
            // name
            var name_label = new Gtk.Label(DesktopFolder.Lang.ITEM_PROPSWINDOW_SHOW_FILENAME.concat(":")); /* translated string */
            var name_value = new Gtk.Label(fname);
            // location
            string location = filepath.replace("/" + fname, "");
            var location_label = new Gtk.Label(DesktopFolder.Lang.ITEM_PROPSWINDOW_SHOW_LOCATION.concat(":")); /* translated string */
            var location_value = new Gtk.Label(location);
            // content type
            var content_label = new Gtk.Label(DesktopFolder.Lang.ITEM_PROPSWINDOW_SHOW_CONTENTTYPE.concat(":")); /* translated string */
